...
public class CardApp {
    ...
    public static void main(String[] args) {
        ...
        card3.balance += -500000;//????你以為使用者很乖?
        System.out.printf("明細 (%s, %d, %d)%n", card1.getNumber(), card1.getBalance(), card1.getBonus());
        System.out.printf("明細 (%s, %d, %d)%n", card2.getNumber(), card2.getBalance(), card2.getBonus());
        System.out.printf("明細 (%s, %d, %d)%n", card3.getNumber(), card3.getBalance(), card3.getBonus());
    }
}
